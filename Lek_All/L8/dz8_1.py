...
# ак зі списку з цифрами [1, 2, 3, 4], має вийти число 1234.
# До нього додаємо 1, і отримуємо 1235. Після цього потрібно розбити отримане
# число на складові цифри. У результаті має бути список [1, 2, 3, 5], який повертає функція.
def add_one(my_list):
    num = "".join(str(digit) for digit in my_list)
    new_num = int(num) + 1
